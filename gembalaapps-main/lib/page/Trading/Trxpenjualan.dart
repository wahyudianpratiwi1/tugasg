...
class Trxpenjualan extends StatefulWidget {
  const Trxpenjualan({Key? key}) : super(key: key);

  @override
  State<Trxpenjualan> createState() => _TrxpenjualanState();
}

class _TrxpenjualanState extends State<Trxpenjualan> {
  @override
