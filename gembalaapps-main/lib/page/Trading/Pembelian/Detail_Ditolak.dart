...
class Pemdetailtolak extends StatefulWidget {
  const Pemdetailtolak({Key? key}) : super(key: key);

  @override
  State<Pemdetailtolak> createState() => _PemdetailtolakState();
}

class _PemdetailtolakState extends State<Pemdetailtolak> {
  @override
